...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($check_cart_numbers) > 0){
      ...
      mysqli_query($conn, "INSERT INTO `cart`(user_id, name, price,author_name,edition, image) VALUES('$user_id', '$product_name', 
      '$product_price','$product_author_name','$product_edition', '$product_image')") or die('query failed');
